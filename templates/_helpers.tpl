...
*/}}
{{- define "admin-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "admin-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "admin-chart.imagePullSecrets" -}}
{{- $global := .Values.global | default dict -}}
